...
class Trainer:
    def __init__(
        ...
        self.global_rank = int(os.environ["RANK"]) #this is the global rank of the current gpu when there are multiple nodes -> this unique across everything
    ...
    def _run_epoch(self, epoch):
        ...
        #use global rank in message printing to identify which gpu is running
